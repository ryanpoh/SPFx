...
import { IRyanPtableProps } from "./IRyanPtableProps";
import { IRyanPTableState } from "./IRyanPTableState";
...
export default class RyanPTable extends React.Component<
  ...
  IRyanPTableState
> {
  constructor(props: IRyanPtableProps) {
    super(props);
  ...
  public render(): React.ReactElement<IRyanPtableProps> {
    return (
      <div>
        <h2>Persons In-Charge</h2>
