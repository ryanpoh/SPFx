...
import { IRyanTableWebpartProps } from "./IRyanTableWebpartProps";
import { IRyanTableWebpartState } from "./IRyanTableWebpartState";
...
export default class RyanTable extends React.Component<
  IRyanTableWebpartProps,
  IRyanTableWebpartState
> {
